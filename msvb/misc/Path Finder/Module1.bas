...
Public Const BigNumber As Integer = 32767
...
End Function
Function CountText(Text As String, SearchText As String) As Integer
...
End Function
Function FindText(Text As String, SearchText As String, Optional Instance As Integer = 1) As Integer
...
End Function
Function FindTextAdv(Text As String, SearchText As String) As Integer
...
End Function
Function FindLast(Text As String, SearchText As String) As Integer
...
End Function
Function ScanText(Text As String, Start As Integer, StopTerm As String) As String
...
End Function
Function GetEntry(Text As String, SepTerm As String, Optional Instance As Integer = 1) As String
...
End Function
Function GetCurLine(Text As String, InsPoint As Integer) As String

    Dim Result As String
    Dim Count As Integer
    
    Count = CountText(Left(Text, InsPoint), vbCrLf)
    Result = GetEntry(Text, vbCrLf, Count + 1)
    GetCurLine = Result
...
End Function
Function GetNextTerm(Text As String, Start As Integer) As String
...
End Function
Function GetShellPtn(Text As String, Start As Integer, Before As String, After As String) As String
...
End Function
Function EditRepeat(Text As String, Number As Integer) As String
...
End Function
Function EditInsert(Text As String, InsPoint As Integer, NewText As String) As String
...
End Function
Function ListFind(List As Collection, Text As String) As Integer
...
End Function
Function ListPrint(List As Collection, Optional SepVar As String = ",") As String

    Dim Item As Variant
    Dim Result As String
    
    For Each Item In List
        Result = Result & CStr(Item) & SepVar
    Next Item
    If Result <> "" Then _
...
End Function
Function ArrayFind(ArrayList() As String, Text As String) As Integer
...
End Function
Function Sort(NameList() As String, ValList() As Integer, First As Integer, Last As Integer)
...
Function Crypt(Text As String, Key As String, Optional Encrypt As Boolean = True) As String
    ...
    Const MaxCode As Integer = 126 '(tilde)
    Const MinCode As Integer = 32 '(space)
    
    Dim i As Integer
    Dim j As Integer
    Dim Result As String
    Dim ShiftDir As Integer
...
End Function
Function ChangeBase(Number As String, Base As Integer, NewBase As Integer) As String
